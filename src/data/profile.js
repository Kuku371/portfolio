...
const profile = {
  ...
  about: [
    "My path through math follows college-level coursework, competitions and camps, and independent research — from linear algebra and abstract algebra to analytic number theory. I'm a leader of the Oregon Math Circle, compete in the USA Math & Coding Olympiad tracks, and I am a research scholar at MIT PRIMES-USA.",
